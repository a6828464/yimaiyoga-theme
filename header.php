...
<?php if ($keywords): ?><meta name="keywords" content="<?php echo esc_attr($keywords); ?>"><?php endif; ?>
  ...
  <nav class="nav-shell">
    <a class="brand" href="<?php echo esc_url(home_url('/')); ?>">
      <?php if (!empty($site['logo'])): ?>
        <img class="brand-logo" src="<?php echo esc_url(yimai_image_url($site['logo'])); ?>" alt="<?php echo esc_attr($site['brand'] ?? 'YI MAI'); ?>" style="height:<?php echo esc_attr((int) ($site['logoHeight'] ?? 13)); ?>px">
      <?php else: ?>
    ...
    <button class="menu-toggle" type="button" data-menu-toggle aria-label="打开菜单">菜单</button>
  </nav>
